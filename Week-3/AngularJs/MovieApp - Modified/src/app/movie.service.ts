...
export class MovieService {
  ...
  private api_key = '5a2cd80ddb89fe9f1c468418faac2316';
  ...
  getTopratedMovies() {
    return this._http.get(this.movie_url + 'discover/movie?sort_by=vote_count.desc' + '&api_key=' + this.api_key);
  }

  getNowplayingMovies() {
    return this._http.get(this.movie_url + 'discover/movie?sort_by=vote_average.desc' + '&api_key=' + this.api_key);
  }
